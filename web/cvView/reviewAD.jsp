        ...
        <div class="container-fluid p-0">
                ...
                <div class="my-auto">
                    ...
                    <div class="resume-item d-flex flex-column flex-md-row mb-5">
                        <div class="resume-content mr-auto">
                            ...
                            <div class="subheading mb-3">Google</div>
                        </div>
            ...
            <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="education">
                <div class="my-auto">
                    ...
                    <div class="resume-item d-flex flex-column flex-md-row mb-5">
                        <div class="resume-content mr-auto">
                            <h3 class="mb-0">Bachelor of Science at Oxford University</h3>
                            <div class="subheading mb-3">GPA: 3.89</div>
                        </div>
                        <div class="resume-date text-md-right">
            ...
            <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="review">
                <div class="my-auto">
                    ...
                    <textarea name="" rows="5" cols="105">
                    </textarea>
                    <input type="submit" value="Submit" name="btnSubmitReview" />
                </div>
            </section>
