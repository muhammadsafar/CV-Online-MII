...
<html lang="en">
    ...
    <body id="page-top">
        <% AppDev ad = (AppDev) session.getAttribute("detail");%>
        <nav class="navbar navbar-expand-lg navbar-dark bg-gray fixed-top" id="sideNav">
            <a class="navbar-nav">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger text-dark" href="#review">Review</a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
                <div class="my-auto">
                    <form action="../servletEditStatusAD" method="GET" >
                        <input class="border border-dark" name="nik" type="hidden" id="nik" class="form-control" value="<%=ad.getNik()%>" >
<!--                        <input class="border border-dark" name="role" type="hidden" id="role" class="form-control" value="<%=ad.getRoleId().getRole()%>" required="required">
                        <input class="border border-dark" name="religion" type="hidden" id="religion" class="form-control" value="<%=ad.getReligionId().getReligion()%>" required="required">-->
                        ...
                        %>
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <p>Status
                                    <select class="btn btn-outline-secondary dropdown-toggle" name="cbStatus">
            ...
            <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="review">
                ...
                <div class="resume-item d-flex flex-column flex-md-row mb-5">
                    <% for (AdSite adSite : ad.getAdSiteList()) { %>
                    <div class="resume-content mr-auto">
                        <h3 class="mb-0"><%= adSite.getSiteId().getSite() %></h3>
                        <div class="subheading mb-3"><%= adSite.getReview() %></div>
                    </div>
                        <%
                        }
                        %>
