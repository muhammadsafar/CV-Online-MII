 ...
 */
@WebServlet(name = "registrasiAppDev", urlPatterns = {"/registrasiAppDev"})
public class registrasiAppDev extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String agama = request.getParameter("cbreligion");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Date tglLahir = dateFormat.parse("2018-08-08");
//            out.println(nik);
//            out.println(nama);
//            out.println(pass);
//            out.println(agama);
            if (adc.saveOrEdit(nik, 
                ...
                out.print(nik);
                dispatcher = request.getRequestDispatcher("hrDanCustomerView/registrasiAD.jsp");
